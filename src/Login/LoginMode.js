    ...
    <View style={styles.container}>
      ...
      <View style={styles.login__mode__layout}>
        <View style={styles.mode_space}>
          <TouchableOpacity onPress={() => props.navigation.navigate('CustomerFoodIDscreen')}>
...
const styles = StyleSheet.create({
  ...
  login__mode__layout: {
    ...
    height: '60%', width: '40%', alignSelf: 'stretch',
    alignItems: 'center', marginRight: 10, backgroundColor: '#FFF',
  ...
  img_mode: {
    ...
    width: null, justifyContent: 'center', padding: 15,
    alignItems: 'center'
  },
});
