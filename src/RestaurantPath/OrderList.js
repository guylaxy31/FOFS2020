            ...
            <View style={styles.container}>
                <View style={styles.cardcontainer}>
                    ...
                    <View style={styles.FirstRow}>
                        <View><Text style={styles.IndexText}>{this.props.idx}</Text></View>
                        <View><Text style={styles.OrderNumberTextTitle}>หมายเลขออเดอร์</Text></View>
                        <View><Text style={styles.OrderNumberTextValue}>{this.props.ordernumber}</Text></View>

                        <View style={{ marginLeft: 'auto' }}><Text style={styles.TimeValueText}>{this.props.timeclock}</Text></View>
                    ...
                    <View style={styles.MenuRow}>
                        <View><Text style={styles.MenuText}>{this.props.menu[0][0]}</Text></View>
                        <View style={{ marginLeft: 'auto', marginRight: 50 }}><Text style={styles.CountingText}>{this.props.menu[0][1]}</Text></View>
                        <View><Text style={styles.PricesText}>{this.props.menu[0][2]} ฿</Text></View>
                    </View>
                    ...
                    <View style={styles.BtnContainer}>
                        <View style={{ backgroundColor: '#FFFC1B', padding: 8, borderRadius: 15 }}><TouchableOpacity><Text style={styles.SubmitBtnText}>ยืนยันรายการ</Text></TouchableOpacity></View>
